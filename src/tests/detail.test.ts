...
const buffer = [
  ...
  0xb4, 0xc6, 0x66, 0xe9, 0xb8, 0x00, 0x00, 0x00, 0x67, 0xff, 0xa0, 0x23, 0x01,
  0x00, 0x00, 0x66, 0xe8, 0xcb, 0x00, 0x00, 0x00, 0x74, 0xfc,
];
const offset = 0x1000;
...
instructions.forEach(function (instr) {
  console.log(instr.detail.x86.operands);
});
