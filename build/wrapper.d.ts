...
export type cs_err = number;
export type cs_arch = number;
export type cs_mode = number;
export type cs_opt_type = number;
export type cs_opt_value = number;
export type cs_group_type = number;
export type cs_op_type = number;
export type cs_ac_type = number;
declare namespace cs {
	...
	class Capstone {
		...
		private open;
		close(): void;
		disasm(buffer: Buffer | number[] | Uint8Array, addr: number, maxLen?: number): cs_insn[];
		disasm_iter(data: {
